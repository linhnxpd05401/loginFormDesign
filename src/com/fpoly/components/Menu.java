...
<<<<<<< HEAD
            ...
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/fpoly/icons/administrative_tools_20px.png")), "Management", "Create Test", "Create Subject"));
...
=======
            ...
            addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/fpoly/icons/administrative_tools_20px.png")), "Management", "Create Test", "Create Subject", "List","Upload Announce"));
>>>>>>> 9d130785f204c356fbbd256ac3e6fe8b8a2f0895
        } else {
